    ...
    <form id="form" class="needs-validation" method="post" novalidate>
        ...
        <div class="question">
            <div class="padding" id="consentDiv">
                    <i>In this experiment your data will be recorded and used for educational purposes. This includes game performance metrics, such as inputs and timings, scores, and answers given in questionnaires.</i>
            </div>
        </div>
